...
import defaultLogo from "../assets/dasacloud-icon.png";
import { FilledTextField } from "../common/StyledComponent";
import { APP_NAME, DASACLOUD_SITE_URL } from "../config/brand";
import { useIsWindows10 } from "../hooks/useIsWindows10";
import { fetchSiteIcon } from "../utils/manifest";
...
export default function AddDrive({ mode = "add" }: AddDriveProps) {
  ...
  const [siteUrl] = useState(isReauthorize ? decodedSiteUrl : DASACLOUD_SITE_URL);
